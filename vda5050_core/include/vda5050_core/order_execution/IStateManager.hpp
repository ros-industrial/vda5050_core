...
public:
    ...
    virtual void append_states_for_update(const vda5050_core::order::Order& order_update) = 0;
    virtual void update_current_order(const vda5050_core::order::Order& order_update) = 0;
};
