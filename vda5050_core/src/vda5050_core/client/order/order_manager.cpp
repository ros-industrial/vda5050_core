...
OrderManager::OrderManager() : current_graph_element_index_{0} {};
  ...
  vda5050_types::Order& order, const vda5050_types::State& state)
{
    ...
    received_order.order_id == current_order_->order_id)
  {
    ...
    if (received_order.order_update_id < current_order_->order_update_id)
    {
      ...
      VDA5050_ERROR(
        "Order Manager Error: orderUpdateError. Received order's "
        "order_update_id is less than the vehicle's current order "
        "order_update_id.");

      /// create error struct
      vda5050_types::Error order_update_deprecated_error{};
      order_update_deprecated_error.error_type =
        "Order Manager Error: orderUpdateError";
      order_update_deprecated_error.error_description =
        "order_update_id of the incoming order is less than the "
        "order_update_id of the order currently on the vehicle";
      order_update_deprecated_error.error_level =
        vda5050_types::ErrorLevel::WARNING;

      /// create error references for this error
      vda5050_types::ErrorReference order_id_error_reference{
        "orderId", received_order.order_id};
      vda5050_types::ErrorReference order_update_id_error_reference{
        "orderUpdateId", std::to_string(received_order.order_update_id)};

      /// add error references to this error
      order_update_deprecated_error.error_references = {
        order_id_error_reference, order_update_id_error_reference};
    ...
    {
      VDA5050_WARN(
        "Order Manager Warning: Received a duplicate order update. Discarding "
        "Order message.");

      /// create error struct
      vda5050_types::Error duplicate_order_update_error{};
      duplicate_order_update_error.error_type = "Order Manager Error";
      duplicate_order_update_error.error_description =
        "order_update_id of the incoming order is equal to the order_update_id "
        "of the order currently on the vehicle.";
      duplicate_order_update_error.error_level =
        vda5050_types::ErrorLevel::WARNING;
      ...
      /// add error references to this error
      duplicate_order_update_error.error_references = {
        order_id_error_reference, order_update_id_error_reference};
      ...
      is_vehicle_still_executing(state) && is_vehicle_waiting_for_update())
    {
      if (
      ...
      {
        VDA5050_ERROR(
          "Order Manager Error: orderUpdateError. Order update has been "
          "rejected as nodeIds of the stitching nodes do not match.");

        reject_order();

        vda5050_types::Error mismatched_stitching_node_error{};
        mismatched_stitching_node_error.error_type =
          "Order Manager Error: orderUpdateError";
        mismatched_stitching_node_error.error_description =
          "node_id of the received order's first node does not match the "
          "node_id of the vehicle's current decision point. Order update is "
          "unable to be stitched with the current order on the vehicle.";
        mismatched_stitching_node_error.error_level =
          vda5050_types::ErrorLevel::WARNING;
        ...
        mismatched_stitching_node_error.error_references = {
          order_id_error_reference, order_update_id_error_reference};
      ...
      {
        /// order update can be accepted as it is a continuation of the
    ...
    else
    {
      if (
        ...
        received_order.nodes.front().node_id != state.last_node_id)
      {
        VDA5050_ERROR(
          "Order Manager Error: orderUpdateError. Order update has been "
          "rejected as it is not a valid continuation of the previously "
          "completed order.");
  ...
  {
    VDA5050_ERROR(
      "Order Manager Error: Update order has been rejected as its order_id "
      "does not match the order_id of the order currently on the vehicle.");

    reject_order();

    vda5050_types::Error not_an_update_order_error{};
    not_an_update_order_error.error_type = "Order Manager Error";
    not_an_update_order_error.error_description =
      "order_id of the received order does not match the order_id of the order "
  ...
  vda5050_types::Order& order, const vda5050_types::State& state)
{
     ...
     received_order.order_id != current_order_->order_id))
  {
    ...
    /// if the vehicle is not carrying out an action and if the vehicle has no
    /// horizon, it can accept a new order
    bool vehicle_ready_for_new_order =
      !is_vehicle_still_executing(state) && !is_vehicle_waiting_for_update();

    /// TODO: This assumes that StateManager sets lastNodeId once the vehicle is
    /// within deviation range
    ...
    else
    {
      ...
      {
        VDA5050_ERROR(
          "Order Manager Error: Vehicle is not ready to accept a new order. "
          "Vehicle is either still executing or waiting for an order update.");

        vda5050_types::Error not_ready_for_new_order_error{};
        not_ready_for_new_order_error.error_type = "Order Manager Error";
        not_ready_for_new_order_error.error_level =
          vda5050_types::ErrorLevel::WARNING;
        not_ready_for_new_order_error.error_description =
          "Vehicle is not ready for a new order as it is still executing its "
          "current order or still has a horizon and hence requires and order "
          "update first.";
      ...
      {
        VDA5050_ERROR(
          "Order Manager Error: noRouteErrror. Received order's start node is "
          "not trivially reachable.");

        vda5050_types::Error not_trivially_reachable_error{};
        not_trivially_reachable_error.error_type =
          "Order Manager Error: noRouteError";
        not_trivially_reachable_error.error_level =
          vda5050_types::ErrorLevel::WARNING;
        not_trivially_reachable_error.error_description =
          "Vehicle cannot reach the new order's first node from the vehicle's "
          "last reached node";

        vda5050_types::ErrorReference first_node_id_error_reference{
          "nodeId", received_order.nodes.front().node_id};

        not_trivially_reachable_error.error_references = {
          first_node_id_error_reference};
  ...
  else
  {
    ...
    VDA5050_ERROR(
      "Order Manager Error: Expected a new order but was given an order with "
      "the same order_id");
    ...
    duplicate_order_error.error_description =
      "OrderManager::make_new_order() was given an order with the same orderId "
      "as the order currently on the vehicle.";

    vda5050_types::ErrorReference new_order_id_error_reference{
      "orderId", received_order.order_id};
    vda5050_types::ErrorReference current_order_id_error_reference{
      "orderId", current_order_->order_id};

    duplicate_order_error.error_references = {
      new_order_id_error_reference, current_order_id_error_reference};
...
const std::optional<std::variant<vda5050_types::Node, vda5050_types::Edge>>
OrderManager::next_graph_element()
{
  ...
  std::variant<vda5050_types::Node, vda5050_types::Edge> graph_element =
...
bool OrderManager::is_vehicle_still_executing(const vda5050_types::State& state)
{
  ...
  if (!state.action_states.empty())
  {
    ...
    {
      if (
        action_state.action_status != vda5050_types::ActionStatus::FINISHED &&
        action_state.action_status != vda5050_types::ActionStatus::FAILED)
      {
...
{
  /// set the state of the current order to the newly accepted order. order_id_
  /// and order_update_id will be updated.
  current_order_ = Order(order);
...
std::vector<vda5050_types::Error> OrderManager::invalid_continuation_errors(
  const Order& received_order, const vda5050_types::State& state)
{
  uint32_t order_start_node_sequence_id{
    received_order.nodes.front().sequence_id};
  ...
  {
    mismatched_sequence_id_error.error_type =
      "Order Manager Error: orderUpdateError";
    mismatched_sequence_id_error.error_description =
      "sequence_id of the incoming order's first node does not match the "
      "vehicle state's last_node_sequence_id.";
    mismatched_sequence_id_error.error_level =
      vda5050_types::ErrorLevel::WARNING;
    mismatched_sequence_id_error.error_references = {
      order_id_error_reference, order_update_id_error_reference};
  ...
  {
    mismatched_node_id_error.error_type =
      "Order Manager Error: orderUpdateError";
    mismatched_node_id_error.error_description =
      "node_id of the incoming order's first node does not match the vehicle "
      "state's last_node_id.";
    mismatched_node_id_error.error_level = vda5050_types::ErrorLevel::WARNING;
    mismatched_node_id_error.error_references = {
      order_id_error_reference, order_update_id_error_reference};
...
{
  auto getSequenceId{
    [](auto const& graph_element) { return graph_element.sequence_id; }};

  auto sequenceIdComparison{[&getSequenceId](auto const& a, auto const& b) {
...
{
  auto isReleased{
    [](auto&& graph_element) -> bool { return graph_element.released; }};
...
void OrderManager::Order::set_decision_point()
{
  ...
  if (
    const vda5050_types::Node* pNode =
      std::get_if<vda5050_types::Node>(&base_.back()))
  {
  ...
  {
    VDA5050_FATAL(
      "Order Manager Error: Last graph element in the given order is not of "
      "type vda50505_types::Node.");
  }
}

/// stitch this order with another order. stitching node could be horizon or
/// base node.
void OrderManager::Order::stitch_order(Order order)
{
  /// check that decision point of this order matches with the first node of the
  /// incoming order and if the first node of the incoming order is released
  ...
  {
    VDA5050_FATAL(
      "Order Manager Error: Stitching node of the incoming order does not "
      "match the current order's decision point.");
    return;
  }
