...
Command Status message for RMF2 AGVs
### Specification
...
<!-- Link to the [example](https://github.com/smart-data-models/dataModel.AutonomousMobileRobot/blob/master/CommandMessage/examples/example.jsonld.csv) (keyvalues) for NGSI-LD in CSV format -->

<!-- Link to the [example](https://github.com/smart-data-models/dataModel.AutonomousMobileRobot/blob/master/CommandMessage/examples/example-normalized.jsonld.csv) (normalized) for NGSI-LD in CSV format -->
